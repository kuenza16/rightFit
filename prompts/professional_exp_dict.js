...
const professional_experience_function_prompt = {
    "type": "array",
        ...
        "properties": {
            ...
            "time_duration": {
                ...
                "properties": {
                    ...
                    "end_date": {
                        "type": "string",
                        "description": `End date of the professional experience in MM-YYYY. If the applicant is still working there, use '${month_year}' as the end date.`,
                    },
                    "duration_months": {
                        "type": "integer",
...
module.exports = professional_experience_function_prompt;