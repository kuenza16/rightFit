let date = new Date();
let month_year = (date.getMonth() + 1).toString().padStart(2, '0') + '-' + date.getFullYear();


const projects_function_prompt = {
    "type": "array",
        ...
        "properties": {
            ...
            "time_duration": {
                ...
                "properties": {
                    ...
                    "end_date": {
                        "type": "string",
                        "description": `End date of the project in MM-YYYY. If the applicant is still working on the project, use '${month_year}' as the end date. If there are no dates in the project, use '-' as the end date.`,
                    },
                    "duration_months": {
                        "type": "integer",
...
module.exports = projects_function_prompt;